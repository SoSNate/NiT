...
import { Zap, BookOpen, Activity, BarChart2, ChevronLeft, LineChart } from 'lucide-react'
    ...
    <div className="min-h-screen p-6" dir="rtl">
      <div className="max-w-5xl mx-auto">
        ...
        <button
          ...
          className="
            mt-5 w-full text-right p-5 rounded-[1.5rem] border backdrop-blur-xl transition-all duration-200
